...
- `facturador-backend`: 59 tests correctos, incluidos endpoints administrativos criticos, protecciones, auditoria, alertas y clasificacion de salud de colas; esquema Prisma valido y todos los `.js` de `src` y `prisma` aprobados por `node --check` el 2026-09-01.
